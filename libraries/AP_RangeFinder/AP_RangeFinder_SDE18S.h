...
#ifndef AP_RANGEFINDER_SDE18S_ENABLED
#define AP_RANGEFINDER_SDE18S_ENABLED AP_RANGEFINDER_BACKEND_DEFAULT_ENABLED
#endif

#if AP_RANGEFINDER_SDE18S_ENABLED

class AP_RangeFinder_SDE18S : public AP_RangeFinder_Backend_Serial
{
public:
    static AP_RangeFinder_Backend_Serial *create(
        RangeFinder::RangeFinder_State &_state,
        AP_RangeFinder_Params &_params) {
        return new AP_RangeFinder_SDE18S(_state, _params);
    }
...
private:
    ...
    char _term[29];                         // buffer for the current term within the current sentence
