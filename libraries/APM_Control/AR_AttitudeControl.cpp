...
#define AR_ATTCONTROL_STEER_RATE_DELTA   0.1f
#define AR_ATTCONTROL_STEER_RATE_ORDER   1

#define AR_ATTCONTROL_THR_SPEED_WC      6.0f
#define AR_ATTCONTROL_THR_SPEED_WO      6.0f
#define AR_ATTCONTROL_THR_SPEED_B0      10.0f
#define AR_ATTCONTROL_THR_SPEED_DELTA   0.0f
...
float AR_AttitudeControl::get_steering_out_rate(float desired_rate, bool motor_limit_left, bool motor_limit_right, float dt)
{
    ...
    if(_steer_rate_ctl_type == Controller_type::ADRC) {
        return get_steering_out_rate_adrc(desired_rate, motor_limit_left, motor_limit_right, dt);
    } 
...
float AR_AttitudeControl::get_steering_out_rate_adrc(float desired_rate,bool motor_limit_left, bool motor_limit_right, float dt)
{
    // sanity check dt
    dt = constrain_float(dt, 0.0f, 1.0f);
