...
const AP_Param::GroupInfo AP_Proximity_Params::var_info[] = {
    ...
    // @RebootRequired: True
    // @User: Standard
    AP_GROUPINFO_FLAGS("TYPE",   1, AP_Proximity_Params, _type, 0, AP_PARAM_FLAG_ENABLE),
    ...
    // @User: Standard
    AP_GROUPINFO("ORIENT", 2, AP_Proximity_Params, _orientation, 0),
    ...
    // @Range: -180 180
    // @User: Standard
    AP_GROUPINFO("YAW_CORR", 3, AP_Proximity_Params, _yaw_correction, 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG1", 4, AP_Proximity_Params, _ignore_angle_deg[0], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID1", 5, AP_Proximity_Params, _ignore_width_deg[0], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG2", 6, AP_Proximity_Params, _ignore_angle_deg[1], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID2", 7, AP_Proximity_Params, _ignore_width_deg[1], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG3", 8, AP_Proximity_Params, _ignore_angle_deg[2], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID3", 9, AP_Proximity_Params, _ignore_width_deg[2], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG4", 10, AP_Proximity_Params, _ignore_angle_deg[3], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID4", 11, AP_Proximity_Params, _ignore_width_deg[3], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG5", 12, AP_Proximity_Params, _ignore_angle_deg[4], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID5", 13, AP_Proximity_Params, _ignore_width_deg[4], 0),
    ...
    // @Range: 0 360
    // @User: Standard
    AP_GROUPINFO("IGN_ANG6", 14, AP_Proximity_Params, _ignore_angle_deg[5], 0),
    ...
    // @Range: 0 127
    // @User: Standard
    AP_GROUPINFO("IGN_WID6", 15, AP_Proximity_Params, _ignore_width_deg[5], 0),
    ...
    // @User: Standard
    AP_GROUPINFO_FRAME("IGN_GND", 16, AP_Proximity_Params, _ign_gnd_enable, 0, AP_PARAM_FRAME_COPTER | AP_PARAM_FRAME_HELI | AP_PARAM_FRAME_TRICOPTER),
    ...
    // @Values: 0:Off, 1:On
    // @User: Advanced
    AP_GROUPINFO("LOG_RAW", 17, AP_Proximity_Params, _raw_log_enable, 0),
    ...
    // @Range: 0 20
    // @User: Advanced
    AP_GROUPINFO("FILT", 18, AP_Proximity_Params, _filt_freq, 0.25f),
    ...
    // @Range: 0 500
    // @User: Advanced
    AP_GROUPINFO("MIN", 19, AP_Proximity_Params, _min_m, 0.0f),
    ...
    // @Range: 0 500
    // @User: Advanced
    AP_GROUPINFO("MAX", 20, AP_Proximity_Params, _max_m, 0.0f),
